...
**Status:** In progress — implementation prepared; target-host baseline pending

**Classification:** Platform Capability

**Phase:** Phase 2 — Shared Platform Capabilities

**Selected Technology:** Trivy 0.72.0
...
- The versioned summary contains counts and image aliases, never detected
