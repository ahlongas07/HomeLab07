...
- Prepare the approved SPIKE-002 PoC with a single-mount read-only Keycloak
  login theme, guarded identity operation, Paperless-ngx identity switches and
  a recovery-first runtime runbook.
